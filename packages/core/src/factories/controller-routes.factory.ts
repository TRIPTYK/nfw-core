 ...
 */
export function createRoute (controllerMetadata: ControllerMetadataArgs, controllerRouter: Router, controllerInstance: unknown, routeMetadata: RouteMetadataArgs, applicationOptions: CreateApplicationOptions) {
  ...
  controllerRouter[routeMetadata.method](routeMetadata.routeName, ...middlewaresForRoute, handleRouteControllerAction(controllerInstance, controllerMetadata, routeMetadata, applicationOptions));
}
