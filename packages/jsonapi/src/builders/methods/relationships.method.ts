...
export async function getRelationships<TModel extends BaseEntity<TModel, any>> (this: HttpBuilder['context'], { resource, endpoint, routeParams, serializer, ctx, service }: JsonApiBuilderRouteParams) {
