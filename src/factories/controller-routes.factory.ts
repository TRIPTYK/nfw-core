 ...
 *
 */
export function createRoute (areaMetadata: AreaMetadataArgs, controllerRouter: Router, controllerInstance: unknown, controllerMetadata: ControllerMetadataArgs, routeMetadata: RouteMetadataArgs, applicationOptions: CreateApplicationOptions) {
  ...
  controllerRouter[routeMetadata.method](routeMetadata.routeName, ...middlewareInstances, handleRouteControllerAction(controllerInstance, areaMetadata, controllerMetadata, routeMetadata, applicationOptions));
}
