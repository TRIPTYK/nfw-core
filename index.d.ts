...
declare class WsController extends BaseController {
	 ...
	 */
	protected sendMessageAndWaitResponse(
		type: string,
		data?: any
	): Promise<string>;
}
...
declare class BaseJsonApiRepository<T> extends Repository<T> {
	 ...
	 * @param req
	 */
	updateRelationshipsFromRequest(
		relationName: string,
		id: string | number,
		body:
			| {
	 ...
	 * @param req
	 */
	removeRelationshipsFromRequest(
		relationName: string,
		id: string | number,
		body:
			| {
...
declare abstract class BaseSerializerSchema<T>
...
declare abstract class BaseJsonApiSerializer<T>
	...
	convertSerializerSchemaToObjectSchema(
...
declare abstract class BaseJsonApiController<
...
> extends BaseController {
	...
	fetchRelationships(
		req: Request,
		res: Response$1
	): Promise<Response$1<any, Record<string, any>>>;
	...
	protected parseJsonApiQueryParams(
 ...
 * @param routeName
 */
declare function RegisterApplication({
	controllers,
	services,
}: {
...
declare function GlobalMiddleware(
 ...
 */
declare function JsonApiEntity<T>(
 ...
 * @param entity
 */
declare function JsonApiController<T extends JsonApiModel<T>>(
	entity: Constructor<T>
): ClassDecorator;
declare function RouteMiddleware<T = any>(
	middlewareClass: Constructor<BaseMiddleware>,
	args?: T
): ClassDecorator;
declare function MethodMiddleware<T = any>(
	middlewareClass: Constructor<BaseMiddleware>,
	args?: T
): MethodDecorator;
declare function JsonApiMethodMiddleware<T = any>(
	middlewareClass: Constructor<BaseMiddleware>,
	args?: T,
	order?: MiddlewareOrder
): MethodDecorator;
declare function OverrideSerializer(schema?: string): MethodDecorator;
declare function OverrideValidator<T>(
...
declare class ApplicationRegistry {
	...
	static registerApplication<T extends BaseApplication>(
		app: Constructor<T>
	): Promise<T>;
	static registerEntity<T extends JsonApiModel<T>>(
		entity: Constructor<T>
	): void;
	static repositoryFor<T extends JsonApiModel<T>>(
		entity: Constructor<T>
	): BaseJsonApiRepository<T>;
	static serializerFor<T extends JsonApiModel<T>>(
		entity: Constructor<T>
	): BaseJsonApiSerializer<T>;
	static registerController(controller: BaseController): void;
	static registerCustomRepositoryFor<T extends JsonApiModel<T>>(
		entity: Constructor<T>,
		repository: Constructor<BaseJsonApiRepository<T>>
	): void;
	static registerSerializerFor<T extends JsonApiModel<T>>(
		entity: Constructor<T>,
		serializer: Constructor<BaseJsonApiSerializer<T>>
	): void;
}
...
declare function getEntityNaming(
	entity: string
): {
	classPrefixName: any;
...
declare function generateJsonApiEntity(
	modelName: string,
	data?: EntityColumns
): Promise<void>;
 ...
 * @returns A promise.
 */
declare function generateBasicRoute(
	prefix: string,
...
declare function getRoutes(): Promise<any>;

declare function removeColumn(
	modelName: string,
 ...
 */
declare function deleteEndpoint(
	prefix: string,
	methodName: string
): Promise<void>;
...
declare function removeRelation(
	entity: string,
 ...
 */
declare function createBaseControllerTemplate({
	fileTemplateInfo,
	classPrefixName,
	filePrefixName,
}: GeneratorParameters): ts_morph.SourceFile;
 ...
 * @param classPrefixName
 */
declare function createControllerTemplate({
	fileTemplateInfo,
	classPrefixName,
	filePrefixName,
}: GeneratorParameters): ts_morph.SourceFile;
 ...
 * @return {SourceFile}
 */
declare function createModelTemplate({
	fileTemplateInfo,
	classPrefixName,
	modelName,
	filePrefixName,
...
declare function createRepositoryTemplate({
	fileTemplateInfo,
	classPrefixName,
	filePrefixName,
}: GeneratorParameters): ts_morph.SourceFile;

declare function createSerializerSchema({
	fileTemplateInfo,
	classPrefixName,
	filePrefixName,
}: GeneratorParameters): ts_morph.SourceFile;

declare function createSerializer({
	modelName,
	fileTemplateInfo,
	classPrefixName,
	filePrefixName,
...
declare function createTestTemplate({
	fileTemplateInfo,
}: GeneratorParameters): ts_morph.SourceFile;

declare function createValidationTemplate({
	fileTemplateInfo,
	classPrefixName,
	filePrefixName,
}: GeneratorParameters): ts_morph.SourceFile;

declare function getJsonApiEntityName(
	prefix: string
): {
	entityName: string;
	tableName: string;
...
declare function buildModelColumnArgumentsFromObject(
	dbColumnaData: EntityColumn
): ColumnOptions;
declare function buildValidationArgumentsFromObject(
	dbColumnaData: EntityColumn
...
export {
	...
	BaseJsonApiSerializer,
	BaseMiddleware,
	BaseModel,
	BaseSerializerSchema,
	BaseSerializerSchemaInterface,
	BaseService,
	Configuration,
